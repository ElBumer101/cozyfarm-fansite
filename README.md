# 🌾 CozyFarm Games — Fan Site

> Sitio web de fans dedicado a los juegos de **CozyFarm Games**, con guías, personajes, consejos y más. Actualmente en desarrollo.
...
├── servicios.html          # Página de servicios/secciones
├── stardew.html            # Guía / página dedicada al juego
├── README.md               # Este archivo
├── .gitignore              # Archivos ignorados por Git
│
├── css/                    # Estilos
│   ├── style.css           # Estilos globales
│   └── soporte.css         # Estilos de soporte/adicionales
│
├── js/                     # Scripts
│   └── main.js
│
...
│
├── video/                  # Videos o assets multimedia
│
...
1. Clona el repositorio:
   ```bash
   git clone https://github.com/tu-usuario/cozyfarm-fansite.git
   ```
